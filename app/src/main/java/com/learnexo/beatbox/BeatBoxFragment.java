...
import com.learnexo.beatbox.databinding.FragmentBeatBoxBinding;
import com.learnexo.beatbox.databinding.ListItemSoundBinding;
...
public class BeatBoxFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding.recyclerView.setAdapter(new SoundAdapter((List<Sound>) mBeatBox.getSounds()));
